...
public:
    void HomePage(int* results) {
        ...
        if (results[1] == 0) { Serial.print("MessageID 0: "); Serial.println(results[1]);
        ...
        } else if (results[1] == 1) { Serial.print("MessageID 1: Came to Second Block! "); Serial.println(results[1]);  
